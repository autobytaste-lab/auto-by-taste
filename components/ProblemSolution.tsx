...
const Card: React.FC<{ title: string; description: string; icon: string; isProblem?: boolean }> = ({ title, description, icon, isProblem }) => (
  <div className={`p-8 rounded-3xl bg-white border ${isProblem ? 'border-[#FF453A]/10' : 'border-[#30D158]/10'} transition-all duration-300 hover:scale-[1.01]`}>
    ...
    <div className="apple-section bg-[#F5F5F5]">
      <div className="max-w-[980px] mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-4xl lg:text-[56px] font-bold text-[#2C2C2C] mb-4 tracking-[-0.03em] leading-tight">{t.problemSolution.heading}</h2>
          <p className="text-[#6B7280] max-w-2xl mx-auto text-lg">{t.problemSolution.description}</p>
        </div>
        ...
        <div className="p-10 lg:p-14 rounded-[28px] bg-white border border-black/5 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#D4AF37]/5 blur-[150px] rounded-full -translate-y-1/2 translate-x-1/2"></div>
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold text-[#2C2C2C] mb-6 tracking-[-0.02em]">{t.problemSolution.solutionTitle}</h3>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-[#78716C]">{t.problemSolution.check1}</span>
                </li>
                <li className="flex items-center space-x-3">
                  <span className="w-5 h-5 bg-[#30D158]/15 text-[#30D158] rounded-full flex items-center justify-center text-xs">✓</span>
                  <span className="text-[#78716C]">{t.problemSolution.check2}</span>
                </li>
                <li className="flex items-center space-x-3">
                  <span className="w-5 h-5 bg-[#30D158]/15 text-[#30D158] rounded-full flex items-center justify-center text-xs">✓</span>
                  <span className="text-[#78716C]">{t.problemSolution.check3}</span>
                </li>
              </ul>
              <div className="p-4 bg-[#30D158]/5 border border-[#30D158]/10 rounded-2xl">
                 ...
                 <p className="text-[#78716C] text-sm italic">{t.problemSolution.commitmentQuote}</p>
              </div>
            </div>

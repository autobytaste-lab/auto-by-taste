    ...
    <div className="apple-section bg-[#0a0a0f]">
      <div className="max-w-[980px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-16">
          <div className="p-8 rounded-3xl bg-[#0a0a0f] border border-[#ff5c5c]/10 transition-all duration-300 hover:scale-[1.01]">
            <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-6 bg-[#ff5c5c]/10">
        ...
        <div className="relative p-8 lg:p-12 rounded-[28px] bg-[#0a0a0f] border border-[#1e2028] overflow-hidden mb-16">
          <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#ff5c5c]/4 blur-[150px] rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-[#1e2028]">
                    ...
                    <th className="text-center py-3 px-4 text-sm font-semibold text-[#ff9090] w-1/3">🦞 Local AI (OpenClaw)</th>
                  </tr>
                </thead>
                <tbody>
                  {comparisonData.map((row, i) => (
                    <tr key={i} className={`border-b border-[#1e2028]/50 ${i % 2 === 0 ? '' : 'bg-[#ff5c5c]/2'}`}>
        ...
        <div className="relative p-10 lg:p-14 rounded-[28px] bg-[#0a0a0f] border border-[#ff5c5c]/20 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-[#ff5c5c]/4 to-[#ff7070]/4"></div>
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="p-4 bg-[#ff5c5c]/5 border border-[#ff5c5c]/15 rounded-2xl">
                <p className="text-sm font-semibold text-[#ff9090] uppercase tracking-widest mb-1">Cam kết của chúng tôi</p>

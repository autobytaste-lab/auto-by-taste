...
export const ChipDiagram: React.FC<{ className?: string }> = ({ className }) => {
  ...
  return (
    <div ref={containerRef} className={`w-full max-w-2xl mx-auto px-4${className ? ` ${className}` : ''}`}>
      ...
      <div role="tablist" aria-label="M4 chip variant selector" className="flex gap-1 mb-6 justify-center bg-[#161920] border border-[#1e2028] rounded-full p-1 max-w-xs mx-auto">
      ...
      >
        ...
        <g>
          ...
          />
          <text x="102" y="50" fill="#f4f4f5" fontSize="15" textAnchor="middle" fontWeight="600" fontFamily="Inter, -apple-system, sans-serif">
            CPU
          </text>
          <text x="102" y="75" fill="#838387" fontSize="13" textAnchor="middle" fontFamily="Inter, -apple-system, sans-serif">
        ...
        <g>
          <use
            ...
            className={shouldAnimate ? 'animate-core-glow' : ''}
          />
          <text x="297" y="50" fill="#f4f4f5" fontSize="15" textAnchor="middle" fontWeight="600" fontFamily="Inter, -apple-system, sans-serif">
            GPU
          </text>
          <text x="297" y="75" fill="#838387" fontSize="13" textAnchor="middle" fontFamily="Inter, -apple-system, sans-serif">
            {gpu}-core
          </text>
        </g>
        ...
        <g>
          <use
            ...
            strokeOpacity={0.15}
          />
          <text x="102" y="180" fill="#f4f4f5" fontSize="15" textAnchor="middle" fontWeight="600" fontFamily="Inter, -apple-system, sans-serif">
            Neural Engine
          </text>
          <text x="102" y="205" fill="#838387" fontSize="13" textAnchor="middle" fontFamily="Inter, -apple-system, sans-serif">
            {tops} TOPS
          </text>
        </g>
        ...
        <g>
          ...
          />
          <text x="297" y="180" fill="#f4f4f5" fontSize="15" textAnchor="middle" fontWeight="600" fontFamily="Inter, -apple-system, sans-serif">
            Memory
          </text>
          <text x="297" y="205" fill="#838387" fontSize="13" textAnchor="middle" fontFamily="Inter, -apple-system, sans-serif">
        ...
        <g>
          <use
            ...
            strokeOpacity={0.5}
          />
          <text x="200" y="275" fill="#838387" fontSize="13" textAnchor="middle" fontFamily="Inter, -apple-system, sans-serif">
            {bw} GB/s bandwidth
          </text>
        </g>
      </svg>

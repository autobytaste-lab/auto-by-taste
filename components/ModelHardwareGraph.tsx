...
const modelColors = ['#4ade80', '#86efac', '#14b8a6', '#3b82f6', '#838387', '#636366'];
            ...
            <div className="p-8 rounded-[28px] bg-[#161920] border border-[#1e2028]">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[#4ade80] font-medium uppercase tracking-widest text-xs">{t.modelHardware.recommendedLabel}</p>
                </div>
              </div>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <div className="p-4 bg-[#13151b] rounded-2xl border border-[#1e2028] flex items-center justify-between">
                    ...
                    <span className="text-[#4ade80] font-semibold">{activeModel.ram}GB RAM</span>
                  </div>
                </div>
                ...
                <button className="w-full py-3.5 bg-[#4ade80] hover:bg-[#86efac] text-white font-semibold rounded-full transition-all duration-300 text-[15px]">

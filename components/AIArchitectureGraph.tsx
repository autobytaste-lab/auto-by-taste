        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="relative mb-6">
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-24 text-right pr-4 hidden md:block">
              <span className="text-xs font-semibold text-[#6366f1] uppercase tracking-wider">{t.aiArchitecture.layer1Label}</span>
              <p className="text-[10px] text-[#636366]">{t.aiArchitecture.layer1Description}</p>
            </div>
            <div className="md:ml-28 bg-[#161920] rounded-2xl p-6 border border-[#6366f1]/10">
              <div className="flex flex-wrap justify-center gap-4">
                {messagingApps.map((app) => (
                  <div
                    key={app.name}
                    className="flex flex-col items-center p-4 bg-[#13151b] rounded-xl border border-[#1e2028] hover:border-[#6366f1]/20 transition-all duration-300 hover:scale-105 cursor-pointer group"
                  >
          ...
          <div className="flex justify-center mb-6">
            <div className="flex flex-col items-center">
              <div className="w-px h-6 bg-gradient-to-b from-[#6366f1]/50 to-[#C0C0C0]/50"></div>
              ...
              <div className="relative bg-[#161920] rounded-2xl p-10 border border-[#2e3040]">
                <div className="flex flex-col items-center">
                  <div className="relative mb-4">
                    ...
                    <div className="relative w-20 h-20 rounded-full bg-gradient-to-br from-[#C0C0C0] to-[#6366f1] flex items-center justify-center">
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    <span className="px-3 py-1 bg-[#6366f1]/10 rounded-full text-xs text-[#6366f1]">RAG</span>
          ...
          <div className="flex justify-center mb-6">
            <div className="flex flex-col items-center">
              <div className="w-px h-6 bg-gradient-to-b from-[#30D158]/50 to-[#6366f1]/50"></div>
              <div className="w-2 h-2 rounded-full bg-[#6366f1]/60"></div>
              <div className="w-px h-6 bg-gradient-to-b from-[#6366f1]/50 to-[#6366f1]/30"></div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-24 text-right pr-4 hidden md:block">
              <span className="text-xs font-semibold text-[#6366f1] uppercase tracking-wider">{t.aiArchitecture.layer4Label}</span>
            ...
            <div className="md:ml-28 bg-[#161920] rounded-2xl p-6 border border-[#6366f1]/10">
              <div className="flex flex-wrap justify-center gap-6">
                {hardware.map((hw) => (
                  <div
                    key={hw.name}
                    className="flex flex-col items-center p-6 bg-[#13151b] rounded-2xl border border-[#1e2028] hover:border-[#6366f1]/20 transition-all duration-300 hover:scale-105 cursor-pointer group min-w-[140px]"
                  >

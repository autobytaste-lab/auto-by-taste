    ...
    <div className="apple-section bg-[#0e1015] overflow-hidden">
      <div className="max-w-[980px] mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-5">
          ...
          <div className="relative p-8 lg:p-10 rounded-[28px] bg-[#161920] border border-[#4ade80]/10 group transition-all duration-300 hover:border-[#4ade80]/20">
            ...
            <h3 className="text-xl font-semibold text-[#f4f4f5] mb-5 flex items-center tracking-[-0.01em]">
              <span className="w-8 h-8 bg-[#4ade80] rounded-full flex items-center justify-center text-xs font-semibold mr-3">01</span>
            ...
            <div className="p-4 bg-[#13151b] rounded-2xl border border-[#1e2028]">
              <p className="text-sm italic text-[#4ade80]">{t.strategy.strategy1Quote}</p>
            </div>

            <div className="mt-6 flex justify-center">
               <div className="w-full h-40 rounded-2xl bg-[#4ade80]/5 border border-[#4ade80]/10 flex items-center justify-center p-6 text-center">

    ...
    <div className="apple-section bg-[#000000]" id="openclaw">
      <div className="max-w-[980px] mx-auto px-6">
        ...
        <div className="text-center mb-20">
          <span className="inline-block px-4 py-2 bg-[#6366f1]/10 border border-[#6366f1]/20 rounded-full text-xs font-medium text-[#a78bfa] mb-6 tracking-wide">
            🦞 Đối tác OpenClaw Chính Thức
          </span>
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-16">
          {services.map((service, i) => (
            <div
              key={i}
              className="group relative p-8 rounded-[28px] bg-[#0a0a0f] border border-[#1e2028] hover:border-[#6366f1]/30 transition-all duration-300 hover:scale-[1.01] overflow-hidden gold-hover-glow"
            >
              <div className="absolute top-0 right-0 w-[200px] h-[200px] bg-[#6366f1]/3 blur-[100px] rounded-full -translate-y-1/2 translate-x-1/2 group-hover:bg-[#6366f1]/6 transition-all duration-500"></div>
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl bg-[#6366f1]/10 flex items-center justify-center mb-6 group-hover:bg-[#6366f1]/20 transition-colors duration-300">
                ...
                <div className="flex flex-wrap gap-2">
                  {service.tags.map((tag) => (
                    <span key={tag} className="px-3 py-1 text-xs rounded-full bg-[#6366f1]/10 text-[#a78bfa] border border-[#6366f1]/15">
                      {tag}
                    </span>
                  ))}
                </div>
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-3 px-8 py-3.5 bg-[#6366f1] hover:bg-[#8b5cf6] text-white font-semibold rounded-full transition-all duration-300 text-[15px] shadow-lg shadow-[#6366f1]/25"
              >

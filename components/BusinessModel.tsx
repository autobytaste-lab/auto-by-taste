    ...
    <div className="apple-section bg-[#13151b]">
      <div className="max-w-[980px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {t.businessModel.models.map((item, i) => (
            <div key={i} className="p-7 rounded-[28px] bg-[#161920] border border-[#1e2028] hover:border-[#2e3040] transition-all duration-300 group hover:scale-[1.01]">
              <div className="text-3xl mb-6 bg-[#13151b] w-12 h-12 rounded-2xl flex items-center justify-center group-hover:bg-[#ff5c5c]/10 transition-colors duration-300">
                {item.icon}
              </div>
              <p className="text-[10px] font-medium text-[#ff5c5c] uppercase tracking-[0.2em] mb-2">{item.highlight}</p>
        ...
        <div className="mt-14 p-10 lg:p-14 rounded-[28px] bg-[#161920] border border-[#1e2028] relative overflow-hidden">
           <div className="absolute inset-0 bg-gradient-to-r from-[#ff5c5c]/3 to-[#C0C0C0]/3"></div>

...
export const vi: Translation = {
  ...
  hero: {
    badge: 'Đối tác dịch vụ OpenClaw chính thức',
    titleLine1: 'Dịch Vụ OpenClaw',
    titleLine2: 'Trọn Gói Cho Bạn.',
    subtitle: 'Cài đặt, tối ưu hiệu suất, tư vấn cá nhân hoá và thiết kế AI Agent theo yêu cầu. Biến OpenClaw thành trợ lý AI đắc lực ngay trên thiết bị của bạn.',
    ctaPrimary: 'Xem bảng giá',
    ctaSecondary: 'Tư vấn miễn phí',
    imageAlt: 'OpenClaw AI Agent Services',
    serviceHighlights: [
      { icon: '🦞', label: 'Cài đặt OpenClaw' },
      { icon: '⚡', label: 'Tối ưu hiệu suất' },
      { icon: '🎯', label: 'Tư vấn cá nhân' },
      { icon: '🤖', label: 'Thiết kế AI Agent' },
    ],
  },
  problemSolution: {
  ...
  openclawServices: {
    badge: 'ĐỐI TÁC OPENCLAW',
    heading: 'Dịch Vụ OpenClaw',
    description: 'AutoByTaste là đơn vị cung cấp dịch vụ OpenClaw chuyên nghiệp — từ cài đặt, đào tạo đến thiết kế AI Agent và tự động hoá quy trình.',
    services: [
      {
        title: 'Cài đặt OpenClaw',
        description: 'Cài đặt và triển khai OpenClaw chuyên nghiệp trên thiết bị của bạn — macOS, Windows hoặc Linux. Trợ lý AI cá nhân sẵn sàng trong vài giờ.',
        icon: '🦞',
      },
      {
        title: 'Đào tạo sử dụng',
        description: 'Đào tạo thực hành OpenClaw cho đội ngũ. Nắm vững Skills, Canvas, tự động hóa trình duyệt và giao tiếp đa kênh.',
        icon: '🎓',
      },
      {
        title: 'Thiết kế AI Agent',
        description: 'Thiết kế và xây dựng AI Agent theo yêu cầu riêng — từ chatbot chăm sóc khách hàng đến quy trình xử lý tài liệu tự động.',
        icon: '🤖',
      },
      {
        title: 'Tự động hoá quy trình',
        description: 'Tự động hoá toàn bộ quy trình công việc với Lobster workflow engine của OpenClaw. Kết nối ứng dụng, API và công cụ liền mạch.',
        icon: '⚡',
      },
    ],
    ctaTitle: 'Sẵn sàng nuôi tôm hùm?',
    ctaDescription: 'Tham gia cộng đồng Telegram để trải nghiệm sản phẩm và bắt đầu ngay.',
    telegramTrial: 'Trải nghiệm sản phẩm',
    telegramGroup: 'Tham gia cộng đồng',
  },
  chatWidget: {
